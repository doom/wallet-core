...
TEST(TWAptosCoinType, TWCoinType) {
    ...
    assertStringsEqual(symbol, "APTOS");
    ASSERT_EQ(TWCoinTypeConfigurationGetDecimals(coin), 8);
    ASSERT_EQ(TWCoinTypeBlockchain(coin), TWBlockchainAptos);
    ASSERT_EQ(TWCoinTypeP2shPrefix(coin), 0x0);
    ASSERT_EQ(TWCoinTypeStaticPrefix(coin), 0x0);
    assertStringsEqual(txUrl, "https://explorer.devnet.aptos.dev/txn/5646");
    assertStringsEqual(accUrl, "https://explorer.devnet.aptos.dev/account/0xf3f2d2bc98bf666bc4869f5ff56723e5c9d252a63209bb2377ea64cd1a41aec0");
}
